<template>
    <div class="bg-slate-background min-h-screen font-roboto">
                    ...
                    <div class="relative flex-1 flex flex-col max-w-xs w-full bg-gray-800">
                        ...
                        <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                            ...
                            <nav class="mt-5 px-2 space-y-1">
                                <a v-for="item in navigation" :key="item.name" :href="item.href" :class="[item.current ? 'text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white', 'group flex items-center px-2 py-2 text-base font-medium rounded-md']">
        ...
        <div class="md:pl-64 flex flex-col flex-1">
            ...
            <main class="flex-1">
                <div class="py-6">
                    <div class="mx-auto px-4 sm:px-6 md:px-8 mx-20">
                        <slot />
                    </div>
                </div>
            </main>
